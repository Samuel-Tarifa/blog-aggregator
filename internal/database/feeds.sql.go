...
SELECT feeds.id, feeds.created_at, feeds.updated_at, feeds.name, feeds.url, feeds.user_id, feeds.last_fetched_at,users.id AS user_id,users.name AS user_name FROM feeds
INNER JOIN users
